...
<head>
    ...
    <title>Ryllanne Petshop Online Shop</title>
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:Pink;">
                        <!--      <img src="images/logo.jpg"  width="15% "/> -->Ryllanne Petshop Online Shop</h4></a>
                </div>
...
<div class="container">
        <section id="contact-info">
            ...
            <div class="left wow fadeInDown">
               ...
               <div class="col-md-6">
                <img src="images/logo2.jpg" class="img-responsive pull-right" />
               </div> 
               <div class="col-md-6">
                <p class="lead">
                    <br>
                    <p><span style="font-size:20px; font-weight:bold; font-family:verdana; color:red;">Jonna Fe Terante</span>
                    <br><b>Address:</b> Brgy. Manalog, Hinunangan Southern Leyte<b><br>Tel/Phone:</b> 09063988086<b><br>Email Address:</b> Jterante@gmail.com</p>
                    <hr>
