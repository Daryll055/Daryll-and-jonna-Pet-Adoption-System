...
<!--    <link href="images/logo.jpg" rel="shortcut icon"> -->
    <title>Ryllanne Petshop Online</title>
...
<body>
      ...
      <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                ...
                <!--      <img src="images/logo.jpg"  width="15% "/> --> Ryllanne Online PetShop </h4></a>
                </div>
        ...
        <div class="col-md-9 wow fadeInDown">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="background-color:#000; padding:10px;">
              ...
              <div class="">
                ...
                <div class="">
                  <img src="images/logo2.jpg" alt="" class="" style="width: 100%;">
                </div>
...
<!--*********************************************Food PACKAGES************************************************-->
        ...
        <div class="col-md-3" >
            <div class="panel panel-default wow fadeInDown">
              ...
              <div class="panel-heading wow fadeInDown" style="font-weight:bold; font-size:16px; color:#36648B;">Welcome To Our online Petshop<i class="glyphicon glyphicon-calendar"></i> <?php echo date('M d, Y');?></div>
            ...
            <div class="panel panel-default wow fadeInDown">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item wow fadeInDown">Dog - <span style="color:#8B8B00; font-weight:bold;">Php 1000.00 to 5000.00 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                 <li class="list-group-item wow fadeInDown">Fish  - <span style="color:#8B8B00; font-weight:bold;">Php 500.00 to 2000.00 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                  <li class="list-group-item wow fadeInDown">Bird  - <span style="color:#8B8B00; font-weight:bold;">Php 1000.00 to 4500.00 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                  
                   <li class="list-group-item wow fadeInDown">Cat- <span style="color:#8B8B00; font-weight:bold;">Php 2000.00 to 6000.00 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                 -->
...
<footer id="footer" class="midnight-blue wow fadeInDown">
        <div class="container">
            <div class="row">
                ...
                <a target="_blank" href="#" title="#">Ryllanne Petshop Online Website</a>
                </div>
                <div class="col-sm-6">
