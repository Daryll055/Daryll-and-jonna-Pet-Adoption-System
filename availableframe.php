...
<!--*********************************************START OF NAVIGATION BAR****************************************--> 
        ...
        ?>
                    ...
                    <td  style="border: 1px dashed #8c8b8b;"><center><strong class="wow fadeInDown"><p style="margin-top:25px;">No.<?php echo $count;?></p></strong></center></td>
                        ...
                        <dt>Breed:</dt> <dd><?php echo $row['name'];?></dd>
...
<div class="modal fade" id="orderModal<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <label>VALID ID is Required*</label>
  ...
  <div class="row">
   ...
   <div class="row" id="datepickup">
    ...
    <div class="col-lg-10">
      ...
      <input type="time" name="timep" class="form-control" />
    </div>
  </div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="savechanges"><i class="glyphicon glyphicon-thumbs-up"></i> Place Order</button>
      </div>
      </form>
    </div>
  </div>
...
if(isset($_POST['savechanges'])){
    ...
    $result=mysqli_query($con, $sql);
			if(mysqli_num_rows($result)==5){
				...
				$sql = ("INSERT INTO tblorders VALUES(NULL,'$name','$address','$contact','$id','$qty','new',NULL,'$otype','$datep','$timep','$folder')") or die (mysqli_error());
        $result=mysqli_query($con, $sql);
							if($result==true){
