...
<head>
    ...
    <title>ADMIN | Ryllanne Petshop Online Shopff</title>
  ...
  <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                   ...
                   <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"> Ryllanne Petshop Online Shop</h4></a>
                </div>
...
<div class="container wow fadeInDown">
    <div class="row">
        ...
        <center><img src="<?php echo $image ?>" class="img-responsive wow fadeInDown" style="height:200px;" /></center>
        <div>  
        ...
        <hr>
                ...
                <h3 style="text-align:center; font-weight:bold;" class="wow fadeInDown">Update Account Information</h3>
        <hr>
             <form class="form-horizontal" name="adminacc" id="adminacc" method="POST" action="adminacc_process.php" style="margin-top: 20px;">
                <table>
                   <tr>
                        ...
                        <td style="text-align:center;">&emsp; <input type="file" name="imageup" value="" required /></td>
                    </tr>
                </table>
