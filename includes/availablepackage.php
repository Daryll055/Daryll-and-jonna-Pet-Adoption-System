    ...
    <div class="col-md-12" style="border: solid #D9D9D9 1px; padding: 10px; padding-top: 5px; box-shadow: #9F9F9F 2px 3px 5px; margin-top: 10px;">
        <div class="panel panel-success">
            <div class="panel-heading panel-title" >
                <span style="font-weight:bold; font-family:verdana;"><i class="glyphicon glyphicon-cog"></i> Available Pets </span>
            </div>
            ...
            <div class="col-lg-6">
            	<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                	<table>
                    	<tr>
                        	<td style="text-align:right; font-weight:bold;">Breed name* : &emsp;</td>
                            <td style="text-align:center;">&emsp;
                                <input type="text" class="form-control" name="cnpname" required>
                            </td>
                        </tr>
                        <tr>
                         ...
                         <tr>
                            <td style="text-align:right;font-weight:bold;">Quantity* : &emsp;</td>
                            <td style="text-align:center;">&emsp; <input type="number" step="any" class="form-control" name="qty" placeholder="number of heads" required /></td>
                        </tr>
                        <tr>
...
//
                                ...
                                $location = "images/upload/" . $_FILES["image"]["name"];
			if(empty($name) || empty($prize) || empty($des) || empty($stat)){
					...
					$sql = ("INSERT INTO tblcnp VALUES(NULL,'$name','$prize','$des','$location','$stat','$qty')") or die (mysql_error());
