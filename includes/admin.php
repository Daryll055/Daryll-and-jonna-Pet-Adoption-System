...
<head>
    ...
    <title>ADMIN | Ryllanne Petshop Online</title>
...
<div class="modal fade" id="viewModal<?php echo $row['id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
	...
	border-bottom: 1px dashed #fff;">
            ...
            <dt>ID Presented:</dt> <dd><img src="<?php echo $row['validid']?>" width="90px;" class="img-responsive img-rounded"></dd>
        </dl>
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center><a target="_blank" href="#" title="#">Petshop Online Website</a></center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
